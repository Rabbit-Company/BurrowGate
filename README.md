...
- SHA-256 browser proof of work, hCaptcha, Cloudflare Turnstile, Google reCAPTCHA (v2 and v3), and interactive Snake, drag-slider, and path-trace game challenge providers
...
| Browser challenge / proof of work                    | ✅ SHA-256 PoW, hCaptcha, Turnstile, reCAPTCHA, Snake, Slider, Trace, pluggable chain | ❌                                       | ❌                                          | ❌                                      | ❌                                    | ❌                                 |
