...
CREATE TABLE IF NOT EXISTS sites (
  ...
  challenge_html_templates_json TEXT NULL,
  challenge_text_overrides_json TEXT NULL,
  challenge_csp_overrides_json TEXT NULL,
...
CREATE TABLE IF NOT EXISTS request_events (
  ...
  origin_id VARCHAR(64) NULL,
	...
	origin_username VARCHAR(255) NULL,
	referer TEXT NULL,
...
CREATE TABLE IF NOT EXISTS streams (
  ...
  incoming_proxy_protocol INTEGER NOT NULL DEFAULT 0,
  proxy_protocol_trusted_cidrs_json TEXT NULL,
  certificate_id VARCHAR(64) NULL,
  event_retention_days INTEGER NOT NULL DEFAULT 7,
  default_ip_action VARCHAR(32) NOT NULL DEFAULT 'inherit',
  default_country_action VARCHAR(32) NOT NULL DEFAULT 'inherit',
...
async function ensureSiteColumns(): Promise<void> {
	const statements = [
		...
		"ALTER TABLE sites ADD COLUMN challenge_html_templates_json TEXT NULL",
		"ALTER TABLE sites ADD COLUMN challenge_text_overrides_json TEXT NULL",
		"ALTER TABLE sites ADD COLUMN challenge_csp_overrides_json TEXT NULL",
...
async function ensureRequestEventColumns(): Promise<void> {
	...
	for (const statement of [
		...
		"ALTER TABLE request_events ADD COLUMN origin_username VARCHAR(255) NULL",
