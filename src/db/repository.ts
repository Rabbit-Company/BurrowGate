...
export const repository = {
	...
	async trafficMetrics(
      ...
      SELECT
        ...
        COUNT(*) AS requests,
        SUM(CASE WHEN decision IN ('blocked','route-blocked','websocket-policy-denied','rate-limited') THEN 1 ELSE 0 END) AS blocked,
	...
	async routeMetrics(
      ...
      SELECT ${bucket} * ${bucketMs} AS bucket,
        ...
        SUM(CASE WHEN decision IN ('route-blocked','websocket-policy-denied') THEN 1 ELSE 0 END) AS blocked
      FROM request_events
