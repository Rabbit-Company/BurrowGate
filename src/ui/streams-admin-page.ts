...
<section id="panel-rules" class="tab-panel hidden">
  ...
  <article class="card rules-list-card">
    ...
    <div class="table-wrap"><table class="table"><thead><tr><th><input id="streamRulesSelectAll" type="checkbox"></th><th>State</th><th>${sortButton("Network", "network_cidr")}</th><th>${sortButton("Action", "action")}</th><th>Reason</th><th>${sortButton("Created", "created_at")}</th><th>${sortButton("Expires", "expires_at")}</th><th></th></tr></thead><tbody id="streamRules"><tr><td colspan="8" class="empty-cell">Open the tab to load rules.</td></tr></tbody></table></div>
