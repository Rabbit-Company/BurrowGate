...
<header class="row between responsive dashboard-header">
  <div><div class="brand"><span class="mark"></span> BurrowGate<span class="version-tag">v${escapeHtml(APP_VERSION)}</span></div><nav class="dashboard-switch" aria-label="Dashboard"><a href="/_burrowgate/admin">Web Proxy</a><a class="active" href="/_burrowgate/admin/streams">Streams</a><a href="/_burrowgate/admin/notifications">Notifications</a></nav><p class="muted header-subtitle">TCP and UDP stream proxy control plane</p></div>
